...
func securityAlertTemplate() string {
	return `<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
        ...
        <table width="480" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:8px; overflow:hidden; box-shadow:0 2px 8px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="padding:32px 28px;">
              <p style="margin:0 0 16px; color:#333333; font-size:15px; line-height:1.6;">Hi there,</p>
              <p style="margin:0 0 24px; color:#333333; font-size:15px; line-height:1.6;">
                Someone tried to create a new acount at <strong>{{ .ServiceURL }}</strong> with your email address. If this was you please proceed to login, otherwise you can safely ignore this email.
              </p>
            </td>
          </tr>
          <!-- Footer -->
    ...
    <tr>
      <td align="center">
        <table width="480" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:8px; overflow:hidden; box-shadow:0 2px 8px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="padding:32px 28px;">
              <p style="margin:0 0 16px; color:#333333; font-size:15px; line-height:1.6;">Welcome back,</p>
              <p style="margin:0 0 24px; color:#333333; font-size:15px; line-height:1.6;">
                We received a login request for your account at <strong>{{ .ServiceURL }}</strong>. Enter the code below to complete your login:
              </p>
              <!-- OTP Code -->
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
        ...
        <table width="480" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:8px; overflow:hidden; box-shadow:0 2px 8px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="padding:32px 28px;">
              <p style="margin:0 0 16px; color:#333333; font-size:15px; line-height:1.6;">Hi there,</p>
              <p style="margin:0 0 24px; color:#333333; font-size:15px; line-height:1.6;">
                We received a request to reset the password for your account at <strong>{{ .ServiceURL }}</strong>. Enter the code below to reset your password:
              </p>
              <!-- OTP Code -->
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
